...
export default function CourseFormHeader({ courseStatus, updateCourseField, onDeleteCourse }: CourseFormHeaderProps) {
  ...
  return (
    <>
      <header className="sticky top-0 z-50 w-full border-b bg-gray-100 dark:bg-gray-900 dark:border-gray-700 dark:text-white backdrop-blur supports-[backdrop-filter]:bg-background/60">
