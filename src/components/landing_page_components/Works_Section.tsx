...
function Works_Section() {
  return (
    <section
      id="how-it-works"
      className="py-8 sm:py-12 md:py-24 lg:py-32 bg-background dark:bg-gray-900"
    >
        ...
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            ...
            <p className="max-w-[900px] text-sm text-muted-foreground sm:text-base md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-300">
              Whether you&rsquo;re here to teach or learn, SkillSphere makes the
                ...
                {[
                  {
                    ...
                    description:
                      "Sign up for free and set up your learning profile with your interests and goals.",
                  },
                  {
                    step: "2",
                    title: "Discover Courses",
                    description:
                      "Browse our extensive catalog of courses or get personalized recommendations.",
                  },
                  {
                    step: "3",
                    title: "Learn at Your Pace",
                    description:
                      "Enroll in courses and learn whenever, wherever, with lifetime access to content.",
                  },
                ].map((step, index) => (
                  <Card key={index} className="dark:bg-gray-800">
                    <CardHeader>
                      ...
                      <CardTitle className="mt-2 dark:text-gray-100">
                        {step.title}
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                ...
                {[
                  {
                    ...
                    description:
                      "Complete our simple application process and showcase your expertise.",
                  },
                  {
                    step: "2",
                  ...
                  },
                  {
                    ...
                    title: "Earn & Grow",
                    description:
                      "Get paid for your knowledge while building your reputation and student base.",
                  },
                ].map((step, index) => (
                  <Card key={index} className="dark:bg-gray-800">
                    <CardHeader>
